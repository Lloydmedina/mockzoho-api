...
ERROR_CATALOG: dict[str, tuple[int, str]] = {
    ...
    "PATTERN_NOT_MATCHED": (400, "Please check whether the input values are correct"),
    "INVALID_REQUEST_METHOD": (400, "The http request method type is not a valid one"),
    "LICENSE_LIMIT_EXCEEDED": (400, "Request exceeds your license limit"),
    "UNABLE_TO_PARSE_DATA_TYPE": (400, "either the request body or parameters is in wrong format"),
    "FEATURE_NOT_SUPPORTED": (403, "The feature is not supported for your edition"),
