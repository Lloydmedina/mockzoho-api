...
LABOR_COSTS = ModuleSpec(
    ...
    fields=(
        ...
        FieldSpec("Technician", "string"),
        FieldSpec("Technician_Count", "integer"),
        FieldSpec("Technician_Hours", "double"),
        FieldSpec("Helper_Hours", "double"),
        FieldSpec("Kilometers_Traveled", "double"),
        FieldSpec("Gas_Type", "string"),
        FieldSpec("Gas_Quantity_Kg", "double"),
        FieldSpec("Meal_Expense", "double"),
        FieldSpec("Other_Expenses", "double"),
        FieldSpec("Expense_Description", "text"),
